    ...
    <form action="index.php" method="POST" accept-charset="utf-8"style="margin: 1rem 0 0 20rem;">
        <table>
            <tr style="height: 4rem;">
                ...
                <td style="transform: translateX(13rem);" ><h3>: اسم الطالب كاملاً</h3></td>            
            </tr>
            <tr style="height: 4rem;">
                ...
                <td style="transform: translateX(13rem);"><h3>: تاريخ الولادة</h3></td>
                </td>
            </tr>
            <tr style="height: 4rem;">
                ...
                <td style="transform: translateX(13rem);"><h3>: جنس الطفل</h3></td>    
                 </td>
            </tr>
           <tr style="height: 4rem;">
                ...
                <option value="اللغة العربية">اللغة العربية</option>
                    <option value="اللغة الانكليزية">اللغة الانكليزية</option>
                </select>
                <td style="transform: translateX(13rem);"><h3>: اختر اللغة التي ترغب بتعليمها لطفلك</h3></td>   
           ...
           <tr style="height: 4rem;">
                ...
                <td style="transform: translateX(13rem);"><h3>هل يستطيع طفلك التحدث بها ؟</h3></td>   
           ...
           <tr style="height: 4rem;">
                ...
                <td style="transform: translateX(13rem);"><h3>هل درسها سابقاً ؟</h3></td>   
           ...
           <tr style="height: 4rem;">
                ...
                <td style="transform: translateX(13rem);"><h3>ما هو مستواه/ها بها ؟</h3></td>   
           ...
           <tr style="height: 4rem;">
                ...
                <td style="transform: translateX(13rem);"><h3>: اسم الأب كاملاً</h3></td>            
            </tr>
            <tr style="height: 4rem;">
                ...
                <td style="transform: translateX(13rem);"><h3>: اسم الأم كاملاًً</h3></td>            
            </tr>
           <tr style="height: 4rem;"> 
                ...
                <option value="الأم">الأم</option>
                    ...
                    <option value="الأم والأب معاً">الأم والأب معاً</option>
                </select>
                <td style="transform: translateX(13rem);"><h3>: المشرف</h3></td>   
            ...
            <tr style="height: 4rem;">
                ...
                <td style="transform: translateX(13rem);"><h3>: الايميل</h3></td>
            </tr>
            <tr style="height: 4rem;">
                ...
                <td style="transform: translateX(13rem);"><h3>: الهاتف</h3></td>
            </tr>
            <tr style="height: 4rem;">
                ...
                <td style="transform: translateX(13rem);"><h3>: البلد</h3></td>
            </tr>
            <tr style="height: 4rem;">
            ...
            <td style="transform: translateX(13rem);"><h3>: اسم المستخدم</h3></td>
            </tr>
            <tr style="height: 4rem;">
            ...
            <td style="transform: translateX(13rem);"><h3>: كلمة السر</h3></td> 
             </tr>
             </tr style="height: 4rem;">
            <tr>
            ...
            <td style="transform: translateX(13rem);"><h3>: تأكيد كلمة السر</h3></td>
