...
{
    $id = $_GET['delete'];
    $stm = "DELETE FROM movies WHERE Id=$id";
...
if(isset($_POST['update']))
{
    ...
    $stm = "UPDATE movies SET Name='$name',Path='$pname',Type='$filetype' WHERE Id=$id";
    mysqli_query($conn,$stm)or die($mysqli->error());
}
...
if(isset($_GET['edit']))
{
    $id = $_GET['edit'];
    $update = true;
    $stm = "SELECT * FROM movies WHERE Id=$id";
...
if(isset($_POST['submit']))
    {
        ...
        $stm = "INSERT INTO movies (Name,Path,Type) VALUES ('$name','$pname','$filetype');";
        try{
           ...
           while( $category = mysqli_fetch_array($data))
           {
               ?>
                <tr>
                    ...
                    <td>
                        <a style="color: white;margin-right: 1rem;border: 1px;border-radius: 100%;padding: .9rem;" href="movie.php?edit=<?php echo $category['Id']; ?>" >Edit</a>
                        <a style="color: white;margin-right: 1rem;border: 1px;border-radius: 100%;padding: .9rem .3rem;" href="movie.php?delete=<?php echo $category['Id']; ?>" >Delete</a>
                    </td>
                </tr>
...
<?php
           ...
           <form style="margin: 4rem 0 0 32rem;" action="movie.php" method="POST" enctype="multipart/form-data">
